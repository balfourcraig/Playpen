const letter_a = () => {
	return {
		instructions:[
			(ctx, penPos, scale) => {
				quadraticTo(ctx, {x: 0.05, y: 0.75}, {x: 0.15, y: 0.55}, {x: 0.4, y: 0.5}, scale, penPos);
			},
			(ctx, penPos, scale) => {
				bezierTo(ctx, {x: 0.4, y: 0.5}, {x: -0.1, y: 0.6}, {x: 0.3, y: 1.2}, {x: 0.45, y: 0.8}, scale, penPos);
			},
			(ctx, penPos, scale) => {
				quadraticTo(ctx, {x: 0.45, y: 0.8}, {x: 0.5, y: 0.2}, {x: 0.2, y: 0.4}, scale, penPos);
			},
			(ctx, penPos, scale) => {
				bezierTo(ctx, {x: 0.2, y: 0.4}, {x: 0.7, y: 0.2}, {x: 0.25, y: 1.2}, {x: 0.55, y: 0.8}, scale, penPos);
			},
		],
